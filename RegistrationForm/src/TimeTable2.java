...
public class TimeTable2{
    ...
    public static void main(String[] args){
        TimeTable2 swingControlDemo = new TimeTable2();
    ...
    private void showTableDemo(){
        ...
        Object[][] data = {
                {"Monday","p.2","assembly", "science","Break","math","English","Lunch","SST"},
                {"Tuesday","p.2","assembly", "science","Break","math","English","Lunch","SST"},
                {"Wednesday","p.2","assembly", "science","Break","math","English","Lunch","SST"},
                {"Thursday","p.2","assembly", "science","Break","math","English","Lunch","SST"},
                {"Friday","p.2","assembly", "science","Break","math","English","Lunch","SST"}
